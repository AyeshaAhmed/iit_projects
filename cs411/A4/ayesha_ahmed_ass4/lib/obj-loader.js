...
//        textureCoords[index_indices * 4 + 1] = textureCoord.y;
        ...
        if(nIdx >= 0){
          ...
          normals[index_indices * 3 + 0] = normal.x;////if normals are specified in object file
          ...
          for(var n=0; n<indices.length; n++){
        	  ...
        	  if(x1==x2&&y1==y2&&z1==z2){
        		  ...
        		  v[0] = normals[n*3+0]+normal.x; 
        		  normals[index_indices * 3 + 0]= v[0];
        		  normals[n*3+0]= v[0];
        		  
        		  v[1] = normals[n*3+1]+normal.y; 
        		  normals[index_indices * 3 + 1] = v[1];
        		  normals[n*3+1]= v[1];
        		  
        		  v[2] = normals[n*3+2]+normal.z; 
